<?php
/*
 * Template Name: Terms and services
 *
 * */
get_header();
?>

    <div class="main servicesPage p-5">
        <h2>Terms and Services</h2>
        <p>
            This website is operated by Marx Cards (Marx Cards Inc.). Throughout the site, the terms "we", "us" and
            "our" refer to Marx Cards Inc. Marx Cards Inc. offers this website, including all information, tools and
            ...
            <br>
            Any new features or tools which are added to the services section shall also be subject to the Terms of
            ...
            those changes.
            <br>
            Our store is hosted on Marx Cards Inc. along with Square Payments. They provide us with the online
            e-commerce payment processing that allows us to sell our services to you.
            <br>
        </p>
        <h3 class="mt-2">
        ...
        <p>
            Prices for our services are subject to change without notice. We reserve the right at any time to modify or
        ...
        <p>
            Certain services may be available exclusively through the website. These services may have limited
            quantities and are subject to No return or exchange according to our Return Policy.
            <br>
            We have made every effort to display as accurately as possible the service information and images of our
            services that appear in payment section. We cannot guarantee that your computer monitor's display of any
            color will be accurate.
            <br>
            We reserve the right, but are not obligated, to limit the sales of our Services to any person, geographic
            region or jurisdiction. We may exercise this right on a case-by-case basis. We reserve the right to limit
            the quantities of services that we offer. All descriptions of services and pricing are subject to change at
            anytime without notice, at the sole discretion of us. We reserve the right to discontinue any product at any
            time. Any offer for any product or service made on this site is void where prohibited.
            <br>
            We do not warrant that the quality of any services, information, or other material purchased or obtained by
        ...
        <p>
            ...
            reserve the right to limit or prohibit service that, in our sole judgment, appear to be placed by group
            submitters.
            <br>
            ...
            needed.
            <br>
            For more detail, please review our <a target="_blank" href="/shipping-policies">Returns Policy</a>.
        </p>
        <h3 class="mt-2">
        ...
        <p>
            Certain content, products and services available via our website ( <a target="_blank" href="/">www.marxcards.com</a>
        ...
        <p>
            Your submission of personal information through the website ( <a target="_blank"
                                                                             href="/">www.marxcards.com</a> ) is
        ...
        <p>
            ...
            inaccuracies or omissions that may relate to service descriptions, pricing, promotions, offers, shipping
            charges, transit times and availability. We reserve the right to correct any errors, inaccuracies or
            ...
            law. No specified update or refresh date applied in the Service or on any related website, should be taken
        ...
        <p>
            ...
            services delivered to you through our website ( <a target="_blank" href="/">marxcards.com</a> ) are (except
            ...
            <br>
            In no case shall Marx Cards Inc., our directors, officers, employees, affiliates, agents, contractors,
            ...
            of the services, or for any other claim related in any way to your use of the services, including, but not
            limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result
            of the use of the service or any content (or product) posted, transmitted, or otherwise made available via
            the services, even if advised of their possibility. Because some states or jurisdictions do not allow the
        ...
        <p>
            You agree to indemnify, defend and hold harmless Marx Cards Inc. and our parent, subsidiaries, affiliates,
        ...
        <p>
            ...
            these Terms of Service at any time by notifying us that you no longer wish to use our Services, and/or when
            you cease using our website ( <a target="_blank" href="/">marxcards.com</a> ).
            <br>
        ...
        <p>
            Questions about the Terms of Service should be sent to us at <a href="mailto:marxcardspsa@gmail.com">marxcardspsa@gmail.com</a>.
        </p>
    </div>
