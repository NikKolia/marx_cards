<?php
/*
 * Template Name: Private policies
 *
 * */
get_header();
?>
    <div class="main list-style servicesPage p-5">
        ...
        <div class="mt-2">
            ...
            make a purchase from <a target="_blank" href="/">www.marxcards.com</a> (the “Site”).
        </div>
        <h3 class="mt-2">PERSONAL INFORMATION WE COLLECT</h3>
        <p>
        ...
        <p>
            We use the Order Information that we collect generally to fulfill any PSA orders includes service level
            placed through the Site (including processing your payment information, arranging for shipping, and
        ...
        <ul>
            ...
            <li>
                ...
                relating to our brand or services.
            </li>
        </ul>
        <br>
        ...
        <p>
            ...
            above. For example, we use Square Payment Services to power our online store--you can read more about how
            Square Payments uses your Personal Information
            <br>
            here: <a target="_blank" href="https://squareup.com/us/en/legal/general/payment">https://squareup.com/us/en/legal/general/payment</a>
            https://squareup.com/us/en/legal/general/payment . We also use Google Analytics to help us understand how
            our customers use the Site -- you can read more about how Google uses your Personal Information
            <br>
            here: <a target="_blank" href="https://www.google.com/intl/en/policies/privacy/">https://www.google.com/intl/en/policies/privacy/</a>.
        ...
        <p>
            ...
            complaint, please contact us by e-mail at <a href="mailto:marxcardspsa@gmail.com">marxcardspsa@gmail.com</a>
